---
name: why
description: "Give a fresh critical second look at the previous recommendation only when the user explicitly invokes $why."
---

# Second look at a recommendation
...
Check the candidate criticisms locally, then explain the reasoning, real weaknesses and whether you still recommend the choice. Keep it short and readable; a clean finding is valid. This is analysis, not authorization to implement a different approach.
