---
name: session-hub
description: "Coordinate several simultaneous Claude Code sessions on one effort through a shared append-only HTML hub on the user's Desktop. Use on /session-hub, 'open a hub', 'run parallel sessions on this', or when told to join an existing hub."
---
